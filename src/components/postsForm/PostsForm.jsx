...
const PostsForm = (props) => {
  ...
  return (
    <div>
      <div>
        <NavLink to={'/'}>
          <button type="button" className="btn__posts btn-primary btn-lg nav_button_form"> Back</button>
        </NavLink>
      </div>
      <div className="posts_content">
        <form onSubmit={props.handleSubmit}>
          <div className="form-group">
            ...
            {createFrom('title', Input, {}, 'form-control', 'submitTitle', 'enter title text', [minLengthPostsFormTitle,maxLengthPostsFormTitle,requiredField])}
          </div>
          ...
          <div className="form-group">
            ...
            <Field name='image' component={Input}  type='file' className='form-control' id='submitImageURL' placeholder= 'enter image url'  />
          </div>
          <div className="form-group">
